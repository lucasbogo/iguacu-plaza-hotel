...
class BookingController extends Controller
{
    ...
    public function payment(Request $request)
    {
        ...
        $placeholderMessage = 'Obrigado por escolher o Iguaçu Plaza Hotel! Estamos trabalhando na implementação do processamento de pagamentos. Em breve, você poderá finalizar sua reserva com pagamento online. Entraremos em contato quando essa funcionalidade estiver disponível.';

        // You can customize the view and message as needed     
        return view('frontend.booking.placeholder_payment', compact('placeholderMessage'));
    }
