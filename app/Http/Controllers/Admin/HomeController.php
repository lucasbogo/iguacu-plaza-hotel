...
class HomeController extends Controller
{
    public function index()
    {
        ...
        return view('admin.home', compact('total_completed_orders', 'total_pending_orders',  'total_rooms', 'total_subscribers', 'orders', 'total_active_customers', 'total_pending_customers'));
    }
}
