...
class CashierClosingRecord extends Model
{
    ...
    {
        // Calculate rental income from all occupants who have made payments within the period
        $rentalIncome = RentPayment::whereBetween('payment_date', [$this->created_at, $this->closed_at])
            ->sum('amount');
