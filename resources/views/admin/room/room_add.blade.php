                        ...
                        <form action="{{ route('admin_room_store') }}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <div class="mb-4">
                                        <label class="form-label">Quantidade total de quartos do tipo *</label>
                                        <input type="text" class="form-control" name="total_rooms"
                                            value="{{ old('total_rooms') }}">
                                    </div>
                                    @php
                                        $selectedAmenities = old('arr_amenities', []);
                                    @endphp
                                        ...
                                        @foreach ($amenities as $item)
                                            <div class="form-check">
                                                <input class="form-check-input" type="checkbox" value="{{ $item->id }}"
                                                    id="defaultCheck{{ $item->id }}" name="arr_amenities[]"
                                                    {{ in_array($item->id, $selectedAmenities) ? 'checked' : '' }}>
                                    ...
                                    <div class="mb-4">
                                        <label class="form-label">Tamanho do Quarto</label>
