...
@section('heading')
    ...
    <h3>Editar Página "Termos e Condições"</h3>
@endsection
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="mb-4">
                                    ...
                                    <select name="terms_status" class="form-control">
                                        <option value="1" @if($page->terms_status == 1) selected @endif>Mostrar</option>
                                        <option value="0" @if($page->terms_status == 0) selected @endif>Esconder</option>
                                    </select>
                                </div>
                                <div class="mb-4">
